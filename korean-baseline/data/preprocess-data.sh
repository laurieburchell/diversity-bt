...
BPE_OPS=16000  # this is quite low because low-resource
SRC="ko"
TRG="en"
OUTPUT_FOLDER="processed-${SRC}${TRG}-data-${BPE_OPS}-bpe-ops"
...
#for lang in $SRC $TRG
#do
#    subword-nmt learn-joint-bpe-and-vocab -i data/train.tc.$lang --write-vocabulary model/vocab.$lang -s $BPE_OPS -o model/$lang.bpe -v
#done
...
#        $SUBWORD_NMT/apply_bpe.py -c model/$lang.bpe --vocabulary model/vocab.$lang --vocabulary-threshold 10 < data/$prefix.tc.$lang > data/$prefix.bpe.$lang
        subword-nmt apply-bpe -c model/$lang.bpe --vocabulary model/vocab.$lang --vocabulary-threshold 10 < data/$prefix.tc.$lang > data/$prefix.bpe.$lang
    done
done
