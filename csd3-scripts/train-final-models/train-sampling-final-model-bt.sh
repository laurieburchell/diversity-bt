...
#MODEL="sampling-final-$SRC$TRG-$TODAY"
MODEL="sampling-final-entr-2021-03-30_0951"
DATA_DIR="/home/cs-burc1/projects/diversity-bt/turkish/mono-data"
#TRAIN_SRC="train.$SRC.pp.filtered"
TRAIN_SRC="/rds/user/cs-burc1/hpc-work/datasets/turkish/backtranslation/sampling/sampling-bt-triple.en"
#TRAIN_TRG="train.$TRG.pp.filtered"
TRAIN_TRG="news.tr.pp.tripled"
DEV_SRC="dev.$SRC.pp"
DEV_TRG="dev.$TRG.pp"
...
$MARIAN \
        ...
        --train-sets $TRAIN_SRC $DATA_DIR/$TRAIN_TRG \
