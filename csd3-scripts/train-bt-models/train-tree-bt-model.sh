...
# train tree bt model to generate tree bt
...
MODEL="tree-bt-$SRC$TRG-$TODAY"
DATA_DIR="/home/cs-burc1/projects/diversity-bt/turkish/parallel-data/tree-labelled-parallel"
TRAIN_SRC="train.tr.pp"
TRAIN_TRG="tree2code-train-tren.en"
DEV_SRC="dev.tr.pp"
DEV_TRG="tree2code-dev-tren.en"
VOCAB="$DATA_DIR/vocab.codes.tren.spm"
